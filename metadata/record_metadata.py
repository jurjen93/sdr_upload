    ...
    metadata = {
      ...
      "custom_fields": {
        "collection:metadata": {
          ...
          "image_size_deg": [fits_meta["naxis1"]*abs(fits_meta['cdelt1']), fits_meta["naxis2"]*abs(fits_meta['cdelt1'])],
          "pixel_units": fits_meta["pixel_units"],
          "polygon_ra_deg": [str(p) for p in polygon_ra],
          "polygon_dec_deg": [str(p) for p in polygon_dec],
          "image_centre_ra_deg": fits_meta["ra_deg"],
          "image_centre_dec_deg": fits_meta["dec_deg"],
